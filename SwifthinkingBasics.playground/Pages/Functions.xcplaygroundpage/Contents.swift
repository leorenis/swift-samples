...
// to call some function, we must pass values such: parameterName: argumentValue
print(checkUserStatus(didCompleteOnboarding: false, profileIsCreated: true))
