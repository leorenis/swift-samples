...
// Version 3
// We can GET the value from outside the object, but we can't SET the value from the outside the object.
// "too public"
// "Best practice"
...
// Note: private and public are by far the most common, but there are many others
//
// open
// public
// internal
