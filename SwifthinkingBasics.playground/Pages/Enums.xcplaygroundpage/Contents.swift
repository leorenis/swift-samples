...
var car3 = CarModel(brand: .nissan, model: "Versa")
var car4 = CarModel(brand: .toyota, model: "Corolla")
var car5 = CarModel(brand: .honda, model: "Accord")

var carBrand: CardBrandOption = .honda
print(carBrand.title)
